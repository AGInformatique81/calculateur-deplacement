...
function getTravelPrice(distanceKm) {
  ...
  // Au-delà de 30 km : 30 € couvrent les 30 premiers km,
  // puis 0,60 € par kilomètre supplémentaire.
...
form.addEventListener("submit", async (event) => {
  ...
  try {
    ...
    const travelPrice = getTravelPrice(distanceKm);\n    priceValue.textContent = `${travelPrice.toLocaleString("fr-FR", { minimumFractionDigits: 2, maximumFractionDigits: 2 })} €`;
